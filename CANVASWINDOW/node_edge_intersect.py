...
class EdgeIntersect:
    ...
    #
    #     :param node: :class:`~GUIWINDOW.node_node.Node` which we started to drag
    ...
    #
    #     :param node: :class:`~GUIWINDOW.node_node.Node` for which we want to get `QRectF` describing its position and area
    #     :type node: :class:`~nodeeditor.node_node.Node`
    ...
    #     :return: :class:`~GUIWINDOW.node_edge.Edge` or `None` if the node is being cut by an `Edge`
    ...
    #
    #     :param node: :class:`~GUIWINDOW.node_node.Node` which connections to check
    #     :type node: :class:`~nodeeditor.node_node.Node`
    #     :return:
    #     """
