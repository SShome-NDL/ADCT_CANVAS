...
class QDMGraphicsEdge(QGraphicsPathItem):
    ...
    def __init__(self, edge:'Edge', parent:QWidget=None):
        """
        :param edge: reference to :class:`~GUIWINDOW.node_edge.Edge`
        ...
        :Instance attributes:
            ...
            - **edge** - reference to :class:`~GUIWINDOW.node_edge.Edge`
    ...
    def createEdgePathCalculator(self):
        """Create instance of :class:`~GUIWINDOW.node_graphics_edge_path.GraphicsEdgePathBase`"""
        self.pathCalculator = self.determineEdgePathClass()(self)
    ...
    def determineEdgePathClass(self):
        ...
        from GUIWINDOW.node_edge import EDGE_TYPE_BEZIER, EDGE_TYPE_DIRECT, EDGE_TYPE_SQUARE
    ...
    def paint(self, painter, QStyleOptionGraphicsItem, widget=None):
        """Qt's overridden method to paint this Graphics Edge. Path calculated
            in :func:`~GUIWINDOW.node_graphics_edge.QDMGraphicsEdge.calcPath` method"""
    ...
    def calcPath(self) -> QPainterPath:
        ...
        is an instance of derived :class:`~GUIWINDOW.node_graphics_edge_path.GraphicsEdgePathBase` class
