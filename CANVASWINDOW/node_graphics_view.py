...
from GUIWINDOW.node_edge_dragging import EdgeDragging
from GUIWINDOW.node_edge_rerouting import EdgeRerouting
from GUIWINDOW.node_edge_intersect import EdgeIntersect
from GUIWINDOW.node_edge_snapping import EdgeSnapping
from GUIWINDOW.node_graphics_cutline import QDMCutLine
...
class QDMGraphicsView(QGraphicsView):
    ...
    def __init__(self, grScene: 'QDMGraphicsScene', parent: 'QWidget'=None):
        """
        :param grScene: reference to the :class:`~GUIWINDOW.node_graphics_scene.QDMGraphicsScene`
        ...
        - **grScene** - reference to the :class:`~GUIWINDOW.node_graphics_scene.QDMGraphicsScene`
        ...
        try:
            ...
            if self.mode == MODE_EDGES_REROUTING:
                ...
                if not EDGE_REROUTING_UE:
                    # version 2 -- more consistent with the GUIWINDOW?
...
#                self.edgeIntersect.leaveState(scenepos.x(), scenepos.y())
    ...
    def mouseMoveEvent(self, event: QMouseEvent):
        ...
        try:
            ...
            if self.mode == MODE_NODE_DRAG:pass
    ...
    def cutIntersectingEdges(self):
        ...
        for ix in range(len(self.cutline.line_points) - 1):
            ...
            # we could cut 3 edges leading to a single GUIWINDOW this will notify it 3x
    ...
    def deleteSelected(self):
        ...
        for item in self.grScene.selectedItems():
            if isinstance(item, QDMGraphicsEdge):
                ...
                d = id(item)
                print("id in node_graphics_view 487",d)
                item.node.remove()
